...
SIGNAL \DEC_Instrucao|saida~6_combout\ : std_logic;
...
SIGNAL \DEC_Instrucao|saida[3]~8_combout\ : std_logic;
...
SIGNAL \DEC_Instrucao|ALT_INV_saida[3]~8_combout\ : std_logic;
...
SIGNAL \DEC_Instrucao|ALT_INV_saida~7_combout\ : std_logic;
SIGNAL \DEC_Instrucao|ALT_INV_saida~6_combout\ : std_logic;
...
\DEC_Instrucao|ALT_INV_saida[3]~8_combout\ <= NOT \DEC_Instrucao|saida[3]~8_combout\;
...
\DEC_Instrucao|ALT_INV_saida~7_combout\ <= NOT \DEC_Instrucao|saida~7_combout\;
\DEC_Instrucao|ALT_INV_saida~6_combout\ <= NOT \DEC_Instrucao|saida~6_combout\;
...
-- pragma translate_on
PORT MAP (
	i => \DEC_Instrucao|ALT_INV_saida~1_combout\,
	devoe => ww_devoe,
...
-- pragma translate_on
PORT MAP (
	i => \DEC_Instrucao|saida~6_combout\,
	devoe => ww_devoe,
...
PORT MAP (
	...
	ena => \DEC_Instrucao|saida~6_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \MUXProxPC|saida_MUX[2]~3_combout\ = ( \incrementaPC|Add0~9_sumout\ & ( (!\MUXProxPC|saida_MUX[4]~0_combout\ & (((\ROM1|memROM~7_combout\)))) # (\MUXProxPC|saida_MUX[4]~0_combout\ & ((!\DEC_Instrucao|saida~7_combout\) # ((\REG_RETORNO|DOUT\(2))))) ) ) # ( 
-- !\incrementaPC|Add0~9_sumout\ & ( (!\MUXProxPC|saida_MUX[4]~0_combout\ & (((\ROM1|memROM~7_combout\)))) # (\MUXProxPC|saida_MUX[4]~0_combout\ & (\DEC_Instrucao|saida~7_combout\ & ((\REG_RETORNO|DOUT\(2))))) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \DEC_Instrucao|ALT_INV_saida~7_combout\,
...
-- Equation(s):
-- \MUXProxPC|saida_MUX[3]~4_combout\ = ( \incrementaPC|Add0~13_sumout\ & ( (!\MUXProxPC|saida_MUX[4]~0_combout\ & (((\ROM1|memROM~8_combout\)))) # (\MUXProxPC|saida_MUX[4]~0_combout\ & ((!\DEC_Instrucao|saida~7_combout\) # ((\REG_RETORNO|DOUT\(3))))) ) ) # 
-- ( !\incrementaPC|Add0~13_sumout\ & ( (!\MUXProxPC|saida_MUX[4]~0_combout\ & (((\ROM1|memROM~8_combout\)))) # (\MUXProxPC|saida_MUX[4]~0_combout\ & (\DEC_Instrucao|saida~7_combout\ & ((\REG_RETORNO|DOUT\(3))))) ) )
...
-- Equation(s):
-- \MUXProxPC|saida_MUX[4]~5_combout\ = (\MUXProxPC|saida_MUX[4]~0_combout\ & ((!\DEC_Instrucao|saida~7_combout\ & ((\incrementaPC|Add0~17_sumout\))) # (\DEC_Instrucao|saida~7_combout\ & (\REG_RETORNO|DOUT\(4)))))
...
-- Equation(s):
-- \MUXProxPC|saida_MUX[5]~6_combout\ = (\MUXProxPC|saida_MUX[4]~0_combout\ & ((!\DEC_Instrucao|saida~7_combout\ & ((\incrementaPC|Add0~21_sumout\))) # (\DEC_Instrucao|saida~7_combout\ & (\REG_RETORNO|DOUT\(5)))))
...
-- Equation(s):
-- \MUXProxPC|saida_MUX[6]~7_combout\ = (\MUXProxPC|saida_MUX[4]~0_combout\ & ((!\DEC_Instrucao|saida~7_combout\ & ((\incrementaPC|Add0~25_sumout\))) # (\DEC_Instrucao|saida~7_combout\ & (\REG_RETORNO|DOUT\(6)))))
...
-- Equation(s):
-- \MUXProxPC|saida_MUX[7]~8_combout\ = (\MUXProxPC|saida_MUX[4]~0_combout\ & ((!\DEC_Instrucao|saida~7_combout\ & ((\incrementaPC|Add0~29_sumout\))) # (\DEC_Instrucao|saida~7_combout\ & (\REG_RETORNO|DOUT\(7)))))
...
PORT MAP (
	clk => \KEY[0]~input_o\,
	d => \MUXProxPC|saida_MUX[7]~8_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \PC|DOUT\(7));
...
-- Equation(s):
-- \MUXProxPC|saida_MUX[8]~9_combout\ = ( \incrementaPC|Add0~33_sumout\ & ( (!\MUXProxPC|saida_MUX[4]~0_combout\ & (((\RAM1|process_0~0_combout\)))) # (\MUXProxPC|saida_MUX[4]~0_combout\ & ((!\DEC_Instrucao|saida~7_combout\) # ((\REG_RETORNO|DOUT\(8))))) ) ) 
-- # ( !\incrementaPC|Add0~33_sumout\ & ( (!\MUXProxPC|saida_MUX[4]~0_combout\ & (((\RAM1|process_0~0_combout\)))) # (\MUXProxPC|saida_MUX[4]~0_combout\ & (\DEC_Instrucao|saida~7_combout\ & ((\REG_RETORNO|DOUT\(8))))) ) )
...
\DEC_Instrucao|saida~6\ : cyclonev_lcell_comb
-- Equation(s):
-- \DEC_Instrucao|saida~6_combout\ = ( !\ROM1|memROM~4_combout\ & ( (!\ROM1|memROM~0_combout\ & (\ROM1|memROM~1_combout\ & (\ROM1|memROM~2_combout\ & \ROM1|memROM~3_combout\))) ) )
...
PORT MAP (
	...
	combout => \DEC_Instrucao|saida~6_combout\);
...
-- Equation(s):
-- \DEC_Instrucao|saida~1_combout\ = ( \ROM1|memROM~4_combout\ ) # ( !\ROM1|memROM~4_combout\ & ( ((!\ROM1|memROM~1_combout\) # ((!\ROM1|memROM~2_combout\) # (\ROM1|memROM~3_combout\))) # (\ROM1|memROM~0_combout\) ) )
...
\DEC_Instrucao|saida[3]~8\ : cyclonev_lcell_comb
-- Equation(s):
-- \DEC_Instrucao|saida[3]~8_combout\ = ( \ROM1|memROM~4_combout\ & ( !\ROM1|memROM~1_combout\ ) ) # ( !\ROM1|memROM~4_combout\ & ( (!\ROM1|memROM~1_combout\) # ((!\ROM1|memROM~0_combout\ & !\ROM1|memROM~2_combout\)) ) )
...
PORT MAP (
	...
	datac => \ROM1|ALT_INV_memROM~2_combout\,
	datae => \ROM1|ALT_INV_memROM~4_combout\,
	combout => \DEC_Instrucao|saida[3]~8_combout\);

\DEC_Instrucao|saida[6]~4\ : cyclonev_lcell_comb
-- Equation(s):
-- \DEC_Instrucao|saida[6]~4_combout\ = ( \ROM1|memROM~4_combout\ & ( (!\ROM1|memROM~0_combout\ & (\ROM1|memROM~1_combout\ & (!\ROM1|memROM~2_combout\ & !\ROM1|memROM~3_combout\))) ) )
...
-- Equation(s):
-- \DEC_Instrucao|saida[5]~3_combout\ = ( \ROM1|memROM~4_combout\ & ( (!\ROM1|memROM~0_combout\ & (\ROM1|memROM~1_combout\ & (!\ROM1|memROM~2_combout\ & !\ROM1|memROM~3_combout\))) ) ) # ( !\ROM1|memROM~4_combout\ & ( (\ROM1|memROM~1_combout\ & 
...
-- Equation(s):
-- \ROM1|memROM~6_combout\ = ( !\PC|DOUT\(8) & ( \ROM1|memROM~10_combout\ & ( (!\PC|DOUT\(4) & (!\PC|DOUT\(5) & (!\PC|DOUT\(6) & !\PC|DOUT\(7)))) ) ) )
...
-- Equation(s):
-- \DEC_Instrucao|saida[4]~2_combout\ = ( \ROM1|memROM~4_combout\ & ( (!\ROM1|memROM~0_combout\ & (\ROM1|memROM~1_combout\ & (!\ROM1|memROM~2_combout\ & !\ROM1|memROM~3_combout\))) ) ) # ( !\ROM1|memROM~4_combout\ & ( (!\ROM1|memROM~0_combout\ & 
...
-- Equation(s):
-- \ULA1|Add0~21_sumout\ = SUM(( !\MUX1|saida_MUX[0]~1_combout\ ) + ( \REGA|DOUT\(0) ) + ( \ULA1|Add0~34_cout\ ))
-- \ULA1|Add0~22\ = CARRY(( !\MUX1|saida_MUX[0]~1_combout\ ) + ( \REGA|DOUT\(0) ) + ( \ULA1|Add0~34_cout\ ))
...
-- Equation(s):
-- \ULA1|saida[0]~5_combout\ = (!\DEC_Instrucao|saida[4]~2_combout\ & ((\ULA1|Add0~21_sumout\))) # (\DEC_Instrucao|saida[4]~2_combout\ & (\MUX1|saida_MUX[0]~1_combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \DEC_Instrucao|ALT_INV_saida[4]~2_combout\,
...
-- Equation(s):
-- \MUX1|saida_MUX[0]~1_combout\ = (!\DEC_Instrucao|saida[6]~4_combout\ & ((\RAM1|ram~165_combout\))) # (\DEC_Instrucao|saida[6]~4_combout\ & (\ROM1|memROM~5_combout\))
...
-- Equation(s):
-- \ULA1|Add0~17_sumout\ = SUM(( !\MUX1|saida_MUX[1]~0_combout\ ) + ( \REGA|DOUT\(1) ) + ( \ULA1|Add0~22\ ))
-- \ULA1|Add0~18\ = CARRY(( !\MUX1|saida_MUX[1]~0_combout\ ) + ( \REGA|DOUT\(1) ) + ( \ULA1|Add0~22\ ))
...
-- Equation(s):
-- \ULA1|saida[1]~4_combout\ = (!\DEC_Instrucao|saida[4]~2_combout\ & ((\ULA1|Add0~17_sumout\))) # (\DEC_Instrucao|saida[4]~2_combout\ & (\MUX1|saida_MUX[1]~0_combout\))
...
-- Equation(s):
-- \MUX1|saida_MUX[1]~0_combout\ = (!\DEC_Instrucao|saida[6]~4_combout\ & ((\RAM1|ram~163_combout\))) # (\DEC_Instrucao|saida[6]~4_combout\ & (\ROM1|memROM~6_combout\))
...
-- Equation(s):
-- \ULA1|Add0~29_sumout\ = SUM(( !\MUX1|saida_MUX[2]~3_combout\ ) + ( \REGA|DOUT\(2) ) + ( \ULA1|Add0~18\ ))
-- \ULA1|Add0~30\ = CARRY(( !\MUX1|saida_MUX[2]~3_combout\ ) + ( \REGA|DOUT\(2) ) + ( \ULA1|Add0~18\ ))
...
-- Equation(s):
-- \ULA1|saida[2]~7_combout\ = (!\DEC_Instrucao|saida[4]~2_combout\ & ((\ULA1|Add0~29_sumout\))) # (\DEC_Instrucao|saida[4]~2_combout\ & (\MUX1|saida_MUX[2]~3_combout\))
...
-- Equation(s):
-- \MUX1|saida_MUX[2]~3_combout\ = (!\DEC_Instrucao|saida[6]~4_combout\ & ((\RAM1|ram~172_combout\))) # (\DEC_Instrucao|saida[6]~4_combout\ & (\ROM1|memROM~7_combout\))
...
-- Equation(s):
-- \ULA1|Add0~25_sumout\ = SUM(( !\MUX1|saida_MUX[3]~2_combout\ ) + ( \REGA|DOUT\(3) ) + ( \ULA1|Add0~30\ ))
-- \ULA1|Add0~26\ = CARRY(( !\MUX1|saida_MUX[3]~2_combout\ ) + ( \REGA|DOUT\(3) ) + ( \ULA1|Add0~30\ ))
...
-- Equation(s):
-- \ULA1|saida[3]~6_combout\ = (!\DEC_Instrucao|saida[4]~2_combout\ & ((\ULA1|Add0~25_sumout\))) # (\DEC_Instrucao|saida[4]~2_combout\ & (\MUX1|saida_MUX[3]~2_combout\))
...
PORT MAP (
	dataa => \DEC_Instrucao|ALT_INV_saida[4]~2_combout\,
	datab => \MUX1|ALT_INV_saida_MUX[3]~2_combout\,
...
-- Equation(s):
-- \MUX1|saida_MUX[3]~2_combout\ = (!\DEC_Instrucao|saida[6]~4_combout\ & ((\RAM1|ram~170_combout\))) # (\DEC_Instrucao|saida[6]~4_combout\ & (\ROM1|memROM~8_combout\))
...
-- Equation(s):
-- \ULA1|Add0~13_sumout\ = SUM(( (!\RAM1|ram~158_combout\) # ((!\DEC_Instrucao|saida[3]~8_combout\ & \DEC_Instrucao|saida[6]~4_combout\)) ) + ( \REGA|DOUT\(4) ) + ( \ULA1|Add0~26\ ))
-- \ULA1|Add0~14\ = CARRY(( (!\RAM1|ram~158_combout\) # ((!\DEC_Instrucao|saida[3]~8_combout\ & \DEC_Instrucao|saida[6]~4_combout\)) ) + ( \REGA|DOUT\(4) ) + ( \ULA1|Add0~26\ ))
...
-- pragma translate_on
PORT MAP (
	datab => \DEC_Instrucao|ALT_INV_saida[3]~8_combout\,
...
-- Equation(s):
-- \ULA1|saida[4]~3_combout\ = (!\DEC_Instrucao|saida[4]~2_combout\ & \ULA1|Add0~13_sumout\)
...
-- Equation(s):
-- \ULA1|Add0~9_sumout\ = SUM(( (!\RAM1|ram~156_combout\) # ((!\DEC_Instrucao|saida[3]~8_combout\ & \DEC_Instrucao|saida[6]~4_combout\)) ) + ( \REGA|DOUT\(5) ) + ( \ULA1|Add0~14\ ))
-- \ULA1|Add0~10\ = CARRY(( (!\RAM1|ram~156_combout\) # ((!\DEC_Instrucao|saida[3]~8_combout\ & \DEC_Instrucao|saida[6]~4_combout\)) ) + ( \REGA|DOUT\(5) ) + ( \ULA1|Add0~14\ ))
...
PORT MAP (
	datab => \DEC_Instrucao|ALT_INV_saida[3]~8_combout\,
	datac => \DEC_Instrucao|ALT_INV_saida[6]~4_combout\,
...
-- Equation(s):
-- \ULA1|saida[5]~2_combout\ = (!\DEC_Instrucao|saida[4]~2_combout\ & \ULA1|Add0~9_sumout\)
...
-- Equation(s):
-- \ULA1|Add0~5_sumout\ = SUM(( (!\RAM1|ram~151_combout\) # ((!\DEC_Instrucao|saida[3]~8_combout\ & \DEC_Instrucao|saida[6]~4_combout\)) ) + ( \REGA|DOUT\(6) ) + ( \ULA1|Add0~10\ ))
-- \ULA1|Add0~6\ = CARRY(( (!\RAM1|ram~151_combout\) # ((!\DEC_Instrucao|saida[3]~8_combout\ & \DEC_Instrucao|saida[6]~4_combout\)) ) + ( \REGA|DOUT\(6) ) + ( \ULA1|Add0~10\ ))
...
-- Equation(s):
-- \ULA1|saida[6]~1_combout\ = (!\DEC_Instrucao|saida[4]~2_combout\ & \ULA1|Add0~5_sumout\)
...
-- Equation(s):
-- \ULA1|Add0~1_sumout\ = SUM(( (!\RAM1|ram~149_combout\) # ((!\DEC_Instrucao|saida[3]~8_combout\ & \DEC_Instrucao|saida[6]~4_combout\)) ) + ( \REGA|DOUT\(7) ) + ( \ULA1|Add0~6\ ))
...
-- Equation(s):
-- \ULA1|saida[7]~0_combout\ = (\ULA1|Add0~1_sumout\ & !\DEC_Instrucao|saida[4]~2_combout\)
...
PORT MAP (
	...
	datad => \DEC_Instrucao|ALT_INV_saida[4]~2_combout\,
	combout => \ULA1|saida[7]~0_combout\);

\FlagZero|DOUT~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \FlagZero|DOUT~1_combout\ = ( \ULA1|Add0~9_sumout\ & ( \ULA1|Add0~13_sumout\ & ( !\DEC_Instrucao|saida[4]~2_combout\ ) ) ) # ( !\ULA1|Add0~9_sumout\ & ( \ULA1|Add0~13_sumout\ & ( !\DEC_Instrucao|saida[4]~2_combout\ ) ) ) # ( \ULA1|Add0~9_sumout\ & ( 
-- !\ULA1|Add0~13_sumout\ & ( !\DEC_Instrucao|saida[4]~2_combout\ ) ) )
...
-- Equation(s):
-- \FlagZero|DOUT~2_combout\ = ( \ULA1|Add0~17_sumout\ & ( \ULA1|Add0~21_sumout\ & ( (!\DEC_Instrucao|saida~1_combout\ & (\DEC_Instrucao|saida[4]~2_combout\ & (!\MUX1|saida_MUX[1]~0_combout\ & !\MUX1|saida_MUX[0]~1_combout\))) ) ) ) # ( 
-- !\ULA1|Add0~17_sumout\ & ( \ULA1|Add0~21_sumout\ & ( (!\DEC_Instrucao|saida~1_combout\ & (\DEC_Instrucao|saida[4]~2_combout\ & (!\MUX1|saida_MUX[1]~0_combout\ & !\MUX1|saida_MUX[0]~1_combout\))) ) ) ) # ( \ULA1|Add0~17_sumout\ & ( !\ULA1|Add0~21_sumout\ & 
-- ( (!\DEC_Instrucao|saida~1_combout\ & (\DEC_Instrucao|saida[4]~2_combout\ & (!\MUX1|saida_MUX[1]~0_combout\ & !\MUX1|saida_MUX[0]~1_combout\))) ) ) ) # ( !\ULA1|Add0~17_sumout\ & ( !\ULA1|Add0~21_sumout\ & ( (!\DEC_Instrucao|saida~1_combout\ & 
-- ((!\DEC_Instrucao|saida[4]~2_combout\) # ((!\MUX1|saida_MUX[1]~0_combout\ & !\MUX1|saida_MUX[0]~1_combout\)))) ) ) )
...
-- Equation(s):
-- \FlagZero|DOUT~3_combout\ = ( \ULA1|Add0~29_sumout\ & ( (\DEC_Instrucao|saida[4]~2_combout\ & (!\MUX1|saida_MUX[3]~2_combout\ & !\MUX1|saida_MUX[2]~3_combout\)) ) ) # ( !\ULA1|Add0~29_sumout\ & ( (!\DEC_Instrucao|saida[4]~2_combout\ & 
-- (((!\ULA1|Add0~25_sumout\)))) # (\DEC_Instrucao|saida[4]~2_combout\ & (!\MUX1|saida_MUX[3]~2_combout\ & (!\MUX1|saida_MUX[2]~3_combout\))) ) )
...
PORT MAP (
	dataa => \DEC_Instrucao|ALT_INV_saida[4]~2_combout\,
	datab => \MUX1|ALT_INV_saida_MUX[3]~2_combout\,
	datac => \MUX1|ALT_INV_saida_MUX[2]~3_combout\,
...
-- Equation(s):
-- \FlagZero|DOUT~4_combout\ = ( \FlagZero|DOUT~2_combout\ & ( \FlagZero|DOUT~3_combout\ & ( ((!\ULA1|saida[7]~0_combout\ & (!\ULA1|saida[6]~1_combout\ & !\FlagZero|DOUT~1_combout\))) # (\FlagZero|DOUT~0_combout\) ) ) ) # ( !\FlagZero|DOUT~2_combout\ & ( 
...
-- pragma translate_on
PORT MAP (
	dataa => \FlagZero|ALT_INV_DOUT~0_combout\,
...
-- Equation(s):
-- \DEC_Instrucao|saida~5_combout\ = ( \ROM1|memROM~4_combout\ & ( (\ROM1|memROM~0_combout\ & (\ROM1|memROM~1_combout\ & (!\ROM1|memROM~2_combout\ & \ROM1|memROM~3_combout\))) ) )
...
-- Equation(s):
-- \MUXProxPC|saida_MUX[4]~0_combout\ = (!\DEC_Instrucao|saida~6_combout\ & (!\DEC_Instrucao|Equal4~0_combout\ & ((!\FlagZero|DOUT~q\) # (!\DEC_Instrucao|saida~5_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \DEC_Instrucao|ALT_INV_saida~6_combout\,
	datab => \DEC_Instrucao|ALT_INV_Equal4~0_combout\,
	datac => \FlagZero|ALT_INV_DOUT~q\,
	datad => \DEC_Instrucao|ALT_INV_saida~5_combout\,
...
-- Equation(s):
-- \MUXProxPC|saida_MUX[1]~2_combout\ = ( \incrementaPC|Add0~5_sumout\ & ( (!\MUXProxPC|saida_MUX[4]~0_combout\ & (((\ROM1|memROM~6_combout\)))) # (\MUXProxPC|saida_MUX[4]~0_combout\ & ((!\DEC_Instrucao|saida~7_combout\) # ((\REG_RETORNO|DOUT\(1))))) ) ) # ( 
-- !\incrementaPC|Add0~5_sumout\ & ( (!\MUXProxPC|saida_MUX[4]~0_combout\ & (((\ROM1|memROM~6_combout\)))) # (\MUXProxPC|saida_MUX[4]~0_combout\ & (\DEC_Instrucao|saida~7_combout\ & ((\REG_RETORNO|DOUT\(1))))) ) )
...
-- Equation(s):
-- \MUXProxPC|saida_MUX[0]~1_combout\ = ( \incrementaPC|Add0~1_sumout\ & ( (!\MUXProxPC|saida_MUX[4]~0_combout\ & (((\ROM1|memROM~5_combout\)))) # (\MUXProxPC|saida_MUX[4]~0_combout\ & ((!\DEC_Instrucao|saida~7_combout\) # ((\REG_RETORNO|DOUT\(0))))) ) ) # ( 
-- !\incrementaPC|Add0~1_sumout\ & ( (!\MUXProxPC|saida_MUX[4]~0_combout\ & (((\ROM1|memROM~5_combout\)))) # (\MUXProxPC|saida_MUX[4]~0_combout\ & (\DEC_Instrucao|saida~7_combout\ & ((\REG_RETORNO|DOUT\(0))))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011000000110101001110100011111100110000001101010011101000111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \DEC_Instrucao|ALT_INV_saida~7_combout\,
	datab => \ROM1|ALT_INV_memROM~5_combout\,
	datac => \MUXProxPC|ALT_INV_saida_MUX[4]~0_combout\,
...
-- Equation(s):
-- \DEC_Instrucao|saida[1]~0_combout\ = ( !\ROM1|memROM~4_combout\ & ( (\ROM1|memROM~1_combout\ & (!\ROM1|memROM~2_combout\ $ (((!\ROM1|memROM~0_combout\ & !\ROM1|memROM~3_combout\))))) ) )
