...
ARCHITECTURE structure OF atv3 IS
...
SIGNAL \decoderI|saida[1]~0_combout\ : std_logic;
...
SIGNAL \decoderI|ALT_INV_saida[1]~0_combout\ : std_logic;
...
\decoderI|ALT_INV_saida[1]~0_combout\ <= NOT \decoderI|saida[1]~0_combout\;
...
\decoderI|saida[1]~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \decoderI|saida[1]~0_combout\ = (!\PC|DOUT\(0) & (!\PC|DOUT\(1) & !\PC|DOUT\(2)))
...
PORT MAP (
	...
	datab => \PC|ALT_INV_DOUT\(1),
	datac => \PC|ALT_INV_DOUT\(2),
	combout => \decoderI|saida[1]~0_combout\);

\ROM1|memROM~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \ROM1|memROM~0_combout\ = (!\PC|DOUT\(2)) # ((!\PC|DOUT\(0) & !\PC|DOUT\(1)))
...
PORT MAP (
	...
	clrn => \decoderI|ALT_INV_saida[1]~0_combout\,
