...
-- *****************************************************************************
-- Generated on "11/04/2024 14:00:31"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          atv16
-- 
...
ENTITY atv16_vhd_vec_tst IS
END atv16_vhd_vec_tst;
ARCHITECTURE atv16_arch OF atv16_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
...
-- INSTRUCTIONS[11]
t_prcs_INSTRUCTIONS_11: PROCESS
BEGIN
	INSTRUCTIONS(11) <= '0';
WAIT;
END PROCESS t_prcs_INSTRUCTIONS_11;
-- INSTRUCTIONS[10]
t_prcs_INSTRUCTIONS_10: PROCESS
BEGIN
	INSTRUCTIONS(10) <= '0';
	WAIT FOR 40000 ps;
	INSTRUCTIONS(10) <= '1';
	...
	INSTRUCTIONS(10) <= '0';
WAIT;
END PROCESS t_prcs_INSTRUCTIONS_10;
-- INSTRUCTIONS[9]
